...
dots.tabs.register('file_explorer_tab', fileController);
...
function createFileUploader(element, tree, editor){
    ...
    var restartDev = document.createElement("button");
    restartDev.innerHTML = 'Restart';
    document.getElementById(element).appendChild(restartDev);
    ...
    button.onclick = function(e){
      ...
      xmlHttp.upload.addEventListener("progress", function(evt){
          if (evt.lengthComputable) {
            ...
            var txt = " Upload: " + Math.round(evt.loaded/1024) + " kb / " + Math.round(evt.total/1024) + " kb";
            console.log(txt);
